...
// Mobile: Skip electron-specific silent monitoring hooks
// Silent monitoring is desktop-only feature
import { usePresenceInit } from './hooks/usePresence';
import notificationService from './services/notificationService';
import { initSync, cleanupSync } from './services/syncService';
...
function AppWithMonitoring() {
  ...
  // Debug: Log user info & init cross-device sync
  React.useEffect(() => {
    if (isLoggedIn && user) {
      console.log('[App Mobile] User logged in:', {
        email: user.email,
        role: user.role,
  ...
  // Mobile: Skip silent monitoring - it's a desktop-only feature
  // (Screen/camera monitoring requires Electron IPC)
