  ...
  return (
    <div className="space-y-4 md:space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-3 gap-2 md:gap-4">
        <div className="card p-3 md:p-4 flex items-center gap-2 md:gap-4">
          ...
          <div>
            <p className="text-lg md:text-2xl font-bold text-gray-900 dark:text-white">{notifications.length}</p>
            <p className="text-xs md:text-sm text-gray-500">Total</p>
          </div>
        </div>
        <div className="card p-3 md:p-4 flex items-center gap-2 md:gap-4">
          <div className="w-10 h-10 md:w-12 md:h-12 bg-yellow-100 dark:bg-yellow-900/30 rounded-xl flex items-center justify-center flex-shrink-0">
            <AlertCircle className="w-5 h-5 md:w-6 md:h-6 text-yellow-600 dark:text-yellow-400" />
          </div>
          <div>
            <p className="text-lg md:text-2xl font-bold text-gray-900 dark:text-white">{unreadCount}</p>
            <p className="text-xs md:text-sm text-gray-500">Unread</p>
          </div>
        </div>
        <div className="card p-3 md:p-4 flex items-center gap-2 md:gap-4">
