...
function SettingsPage() {
  ...
  const handleProfileSave = async () => {
    setLoading(true);
    try {
      await settingsAPI.update(user.id, { profile });
  ...
  const handleNotificationsSave = async () => {
    setLoading(true);
    try {
      await settingsAPI.update(user.id, { notifications });
  ...
  const handlePreferencesSave = async () => {
    setLoading(true);
    try {
      await settingsAPI.update(user.id, { preferences });
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
                <div className="relative">
                  {profile.avatar ? (
                    ...
                    <div className="w-20 h-20 md:w-24 md:h-24 rounded-full bg-gradient-to-br from-guardian-400 to-guardian-600 flex items-center justify-center text-white text-2xl md:text-3xl font-bold">
